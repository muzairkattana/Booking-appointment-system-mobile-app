...
/// Patched version of RecordLinux that adds the missing [startStream] and
/// fixes the [hasPermission] signature to match record_platform_interface >=1.5.0.
class RecordLinux extends RecordPlatform {
  ...
  /// Fixed signature: added optional named parameter `request` to match the
  /// interface defined in record_platform_interface >=1.5.0.
  @override
  ...
  /// Added implementation of [startStream] required by record_platform_interface >=1.5.0.
  /// Linux does not support streaming; throws [UnsupportedError] like other
  /// desktop platforms that haven't implemented this feature.
  @override
  Future<Stream<Uint8List>> startStream(
      String recorderId, RecordConfig config) {
    throw UnsupportedError(
      'startStream is not supported on Linux. Use start() with a file path instead.',
    );
  }
